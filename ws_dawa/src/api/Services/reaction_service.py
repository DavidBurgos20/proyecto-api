...
class ReactionDetailService(Resource):
    @staticmethod
    def get(reaction_id):
        try:
            HandleLogs.write_log("Ejecutando servicio de obtener reacción por ID")
            resultado = ReactionComponent.getReactionById(reaction_id)
